...
#define SYS_CLK_UPLL_BEFORE_DIV2_FREQ       480000ul
#define SYS_CLK_CONFIG_PRIMARY_XTAL         80000ul
...
*/
#define TXTHREAD_DRV_I2C_INDEX   			    0
#define TXTHREAD_PERPH_I2C_INDEX 			    I2C_ID_1

#define TXTHREAD_DATABUFF_SIZE_BYTES          (TXTHREAD_I2C_DRV_BYTE_COUNT)
#define TXTHREAD_DATABUFF_SIZE_DWORDS         ((TXTHREAD_I2C_DRV_BYTE_COUNT)/4)
